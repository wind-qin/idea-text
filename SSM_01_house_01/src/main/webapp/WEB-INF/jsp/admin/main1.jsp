    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="javascript:if(confirm('确实要退出登录吗?'))location='/user/logout'">退出</a></li>
            </ul>
        </div>
    </div>
</div>
<div class="container clearfix">
     <div class="sidebar-wrap">
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <div class="p"><ul class="sub-menu">
                        <li><a href="/house/showHouseList"><i class="icon-font">&#xe008;</i>房源列表</a></li>
                         <li><a href="/house/toaddhouse"><i class="icon-font">&#xe008;</i>添加房源</a></li>
             ...
             <div class="p">         <ul class="sub-menu">
                        <li><a href="/zu/toZuList"><i class="icon-font">&#xe017;</i>在租列表</a></li>
                      
                        <li><a href="/check/getAllCheckOut"><i class="icon-font">&#xe037;</i>已退租列表</a></li>
        ...
        <div class="p">            <ul class="sub-menu">
                        <li><a href="/apply/findAllApply"><i class="icon-font">&#xe037;</i>看房申请</a></li>
                       	<li><a href="/applyout/findAllApplyOut"><i class="icon-font">&#xe037;</i>退租申请</a></li>
       ...
       <div class="p">              <ul class="sub-menu">
            ...
            <div class="p">          <ul class="sub-menu">
               ...
               <div class="p">      <ul class="sub-menu">
                        <li><a href="/findAllUserList"><i class="icon-font">&#xe017;</i>账户管理</a></li>
